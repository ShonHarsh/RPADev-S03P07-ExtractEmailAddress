...
# S03P07 Extract Email Address

This project is my solution in **C#** to the **Extract Email Address** practice found in section 03 practice 07 of the UiPath - RPA Developer Foundation course.
...
**Practice:** 07 Extract Email Address

**Project Format:** Windows, C#

**GitHub:** https://github.com/ShonHarsh/RPADev-S03P07-ExtractEmailAddress

### Sample Output

```sh
04/16/2024 15:00:52 => [Debug] Debug started for file: Main
04/16/2024 15:00:53 => [Info] RPADev-S03P07-ExtractEmailAddress execution started
04/16/2024 15:00:53 => [Info] RPADev-S03P07-ExtractEmailAddress.Main.Begin;
04/16/2024 15:00:53 => [Info] RPADev-S03P07-ExtractEmailAddress.Main.Print; Email: john.doe@localcompany.com
04/16/2024 15:00:53 => [Info] RPADev-S03P07-ExtractEmailAddress.Main.End;
04/16/2024 15:00:53 => [Info] RPADev-S03P07-ExtractEmailAddress execution ended in: 00:00:00
```
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S03P07-ExtractEmailAddress
```
